...
@keyframes changetext{
    ...
    80%{content: "Festival celebration";}
...
%>
    ...
    <div class="home">
        <div class="content">
            <h5>Welcome <%=session.getAttribute("uname")%></h5>
          ...
          %>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <a href="#">Admin Can't book event</a>
                <%} else{ %>
        ...
        <div class="row" style="margin-top: 30px;">
          ...
          <div class="col-md-4 py-3 py-md-0">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p>“Affordable luxury at its finest.”</p>
              </div>
            </div>
          ...
          <div class="col-md-4 py-3 py-md-0">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <h3>Food & Drinks</h3>
                <p>“Flavors that dance on the palate.”</p>
              </div>
            </div>
          ...
          <div class="col-md-4 py-3 py-md-0">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <h3>Safety Guide</h3>
                <p>"Creating Secure Experiences".</p>
              </div>
            </div>
          </div>
        </div>
