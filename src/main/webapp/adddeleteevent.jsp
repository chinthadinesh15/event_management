...
<body>
	...
	<video autoplay loop muted>
                <source src="https://videos.pexels.com/video-files/8671663/8671663-uhd_2560_1440_24fps.mp4" type="video/mp4">
            </video>
    </div>
	<center>
								...
								<div class="login-space">
									<div class="login">
										...
										<div class="group">
											...
											<input type="submit" class="button" name="addevent" value="Add">
									</div>
									<div class="sign-up-form">
										<div class="group">
											...
											<input type="submit" class="button" name="delevent" value="Delete">										
									</div>
								</div>
							</div>
						</div>
